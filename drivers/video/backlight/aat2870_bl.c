...
/* 
  ...
  * 2010-05-18, minjong.gong
  */

#define LCD_LED_MAX 17 /* 13.5mA */ /* TODO: it should be modified for saving currnet */
...
MODULE_AUTHOR("Bongkyu Kim <bongkyu.kim>");
MODULE_LICENSE("GPL");
