...
int msm_fb_refesh_enabled = 1;	//  [bluerti] 2009-07-18
...
//LGE_CHAGE_S	ALESSI	
			mfd->op_enable = FALSE;	/* bob.cho : flag op_enable to false when lcd on	*/
			mdelay(10);
//LGE_CHAGE_E	ALESSI	
...
//LGE_CHAGE_S	ALESSI	
				mfd->op_enable = TRUE;	/* bob.cho : flag op_enable to true after lcd on	*/
//LGE_CHAGE_E	ALESSI	
		}
		break;
